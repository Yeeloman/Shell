...
/**
 *inputFix - fixes the input from \n and spaces
 *@data: all the relevent data
...
/**
 *commandChecker - functions that checks the commands
 *@data: command line
 */
...
/**
 *checkSlash - functions that checks the slash command
 *@data: command line
 *@lepath: the path from the previous function
